    ...
    float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
    {
        ...
        #ifdef POI_LIGHTING
            finalLighting = calculateLighting(albedo.rgb, finalColor);
        #endif
        ...
        if(_Mode >= 1)
        {
            ...
            depthTouchEmission = applyDepthColor(finalColor, finalEmission, poiCam.screenPos, poiCam.clipPos);
        #endif
        ...
        float4 finalColorBeforeLighting = finalColor;
            ...
            #ifdef POI_RIM
                ApplyRimEmission(finalEmission, finalColor);
            #endif
