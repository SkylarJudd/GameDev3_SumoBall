    ...
    void calculateRimLighting()
    {
        ...
        rimWidth = lerp(rimWidth, rimWidth * lerp(0, 1, poiLight.lightMap - _ShadowMixThreshold) * _ShadowMixWidthMod, _ShadowMix);
    ...
    void ApplyRimEmission(inout float3 finalEmission, float4 finalColor)
    {
