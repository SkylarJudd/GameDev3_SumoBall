    ...
    float3 calculateSpecular(in float4 albedo)
    {
        ...
        if(_SpecularType == 4)
        {
            ...
            if (_SpecularType == 3) // anisotropic
            {
                ...
                finalSpecular += AnisotropicSpecular(_SpecWhatTangent, _AnisoUseTangentMap, _SpecularSmoothness, _Spec2Smoothness, _AnisoSpec1Alpha, _AnisoSpec2Alpha, _SpecularTint, _SpecularMetallic, specularMap, poiLight.color, poiLight.direction, poiLight.halfDir, poiLight.nDotL, jitter, packedTangentMap, albedo);
                finalSpecular *= _SpecularTint;
                finalSpecular *= lerp(1, poiLight.attenuation, _SpecularAttenuation);
            }
        #endif
        ...
        if (_EnableSpecular1)
        {
            ...
            if (_SpecularType1 == 3) // anisotropic
            {
                ...
                finalSpecular1 = AnisotropicSpecular(_SpecWhatTangent1, _AnisoUseTangentMap1, _SpecularSmoothness1, _Spec2Smoothness1, _AnisoSpec1Alpha1, _AnisoSpec2Alpha1, _SpecularTint1, _SpecularMetallic1, specularMap1, poiLight.color, poiLight.direction, poiLight.halfDir, poiLight.nDotL, jitter, packedTangentMap, albedo);
                finalSpecular1 *= _SpecularTint1;
                finalSpecular1 *= lerp(1, poiLight.attenuation, _SpecularAttenuation1);
            }
